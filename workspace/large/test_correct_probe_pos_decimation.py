    ...
    for scan_idx in scan_indices[rank::n_ranks]:
        for decimation_ratio in decimation_ratios:
            ...
            run_pos_corr(scan_idx,
                         'outputs/pred_test{}_model_36SpiralDatasets_dataDecimation_{}/pred_phase.tiff'.format(scan_idx, decimation_ratio),
                         save_path=os.path.join('outputs', 'dataDecimation_{}'.format(decimation_ratio))
                         )
